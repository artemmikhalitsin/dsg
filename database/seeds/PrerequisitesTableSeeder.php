...
class PrerequisitesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('prerequisites')->insert([
			...
			[
				'course_id' => DB::table('courses')->where('course_code', 'PHYS 206')->value('course_id'),
				'prerequisite' => DB::table('courses')->where('course_code', 'PHYS 204')->value('course_id'),
				'iscorequisite' => 0
			],
			[
				'course_id' => DB::table('courses')->where('course_code', 'CHEM 206')->value('course_id'),
				'prerequisite' => DB::table('courses')->where('course_code', 'CHEM 205')->value('course_id'),
				'iscorequisite' => 0
			],
			[
			...
			[
				...
				'prerequisite' => DB::table('courses')->where('course_code', 'BIOL 201')->value('course_id'),
				'iscorequisite' => 0
			],
			[
				'course_id' => DB::table('courses')->where('course_code', 'BIOL 261')->value('course_id'),
			...
			[
				'course_id' => DB::table('courses')->where('course_code', 'BIOL 261')->value('course_id'),
				'prerequisite' => DB::table('courses')->where('course_code', 'CHEM 206')->value('course_id'),
				'iscorequisite' => 0
			],
			[
			...
			[
				'course_id' => DB::table('courses')->where('course_code', 'CHEM 217')->value('course_id'),
				'prerequisite' => DB::table('courses')->where('course_code', 'PHYS 206')->value('course_id'),
				'iscorequisite' => 0
			],
			[
				'course_id' => DB::table('courses')->where('course_code', 'CHEM 217')->value('course_id'),
				'prerequisite' => DB::table('courses')->where('course_code', 'PHYS 224')->value('course_id'),
				'iscorequisite' => 0
			],
			[
				'course_id' => DB::table('courses')->where('course_code', 'CHEM 217')->value('course_id'),
				'prerequisite' => DB::table('courses')->where('course_code', 'PHYS 226')->value('course_id'),
				'iscorequisite' => 0
			],
			[
				'course_id' => DB::table('courses')->where('course_code', 'CHEM 217')->value('course_id'),
			...
			[
				...
				'prerequisite' => DB::table('courses')->where('course_code', 'PHYS 284')->value('course_id'),
				'iscorequisite' => 0
			],
		]);
    }
