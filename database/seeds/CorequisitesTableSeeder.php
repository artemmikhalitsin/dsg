...
class CorequisitesTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        DB::table('corequisites')->delete();

        DB::table('corequisites')->insert([
        	[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENCS 282')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENGR 108')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MATH 204')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
					['course_id', '=', DB::table('courses')->where('course_code', 'ENGR 213')->value('course_id')],
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MATH 205')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENGR 213')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
					['course_id', '=', DB::table('courses')->where('course_code', 'ENGR 242')->value('course_id')],
				...
				'corequisite' => DB::table('courses')->where('course_code', 'PHYS 204')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MATH 203')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENGR 208')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENGR 233')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 372')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COEN 243')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COEN 212')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 311')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COEN 311')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COEN 346')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'SOEN 341')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COEN 231')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COEN 244')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COEN 313')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COEN 317')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COEN 352')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENGR 371')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'PHYS 205')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'AERO 201')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENGR 201')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENGR 243')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'AERO 390')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'AERO 464')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENGR 311')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MECH 351')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MECH 361')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'AERO 462')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'AERO 371')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MECH 221')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'AERO 482')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'AERO 486')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 273')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'CHEM 205')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 251')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 242')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 264')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 342')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 321')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 421')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 331')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 390')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 351')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 453')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 367')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COEN 445')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ELEC 463')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENGR 391')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MECH 313')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MECH 211')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENGR 244')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENGR 251')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENGR 361')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'ENGR 245')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MECH 311')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MECH 215')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MECH 375')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MECH 343')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MECH 447')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MECH 352')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'MATH 201')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 108')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 248')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
					['course_id', '=', DB::table('courses')->where('course_code', 'COMP 228')->value('course_id')],
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 218')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 346')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 232')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 352')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 228')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 249')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 371')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 353')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 361')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 233')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 490')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'SOEN 343')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'SOEN 342')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'COMP 354')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'SOEN 344')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'corequisite' => DB::table('courses')->where('course_code', 'SOEN 387')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'corequisite' => DB::table('courses')->where('course_code', 'SOEN 390')->value('course_id')
			],
        ]);
    }
}
