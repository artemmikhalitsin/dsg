    ...
    public function run()
    {
        ...
        DB::table('corequisites')->insert([
			...
			[
				...
				'course_id' => DB::table('courses')->where('course_code', 'ENGR 108')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
			...
			[
				...
				'course_id' => DB::table('courses')->where('course_code', 'MATH 201')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
				...
				'course_id' => DB::table('courses')->where('course_code', 'COMP 108')->value('course_id')
			],
			[
				'prereq_id' => DB::table('prerequisites')->where([
